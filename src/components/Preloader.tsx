...
// Server-rendered so the navy overlay is the very first paint on a cold visit.
  ...
  return (
    <>
      <div
        ...
        className="fixed inset-0 z-[100] flex items-center justify-center bg-navy transition-transform ease-in"
        style={{
          transform: lifted ? "translateY(-100%)" : "none",
          transitionDuration: `${LIFT_MS}ms`,
        }}
      >
        <span className="relative font-display text-3xl text-ivory/25 md:text-5xl">
          {brand}
          <span
            aria-hidden
