...
export const homepage: SiteContent["homepage"] = {
  hero: {
    eyebrow: "[НАЗВАНИЕ КЛИНИКИ] · ТАШКЕНТ", // TODO
    heading: "Стоматология хирургического уровня",
    subhead: "От имплантации до челюстно-лицевой хирургии — [15]+ лет опыта, [3 000]+ операций", // TODO
  ...
  about: {
    ...
    statement:
      "Мы не пункт протезирования — мы хирургический центр. Каждый план лечения начинается с КТ-диагностики и лично утверждается хирургом.",
    linkLabel: "Подробнее →",
  },
  services: {
    eyebrow: "Услуги",
    heading: "Хирургия — ядро клиники",
    intro: "[Краткое описание — почему хирургическое направление выделяет клинику]", // TODO
